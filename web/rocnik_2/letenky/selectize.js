...
(function (root, factory) {
    ...
    var autoGrow = function ($input) {
        ...
        var update = function (e, options) {
            ...
            width =
                Math.max(measureString(value, $input), placeholderWidth) + 4;
    ...
    $.extend(Selectize.prototype, {
            ...
            for (i = 0; i < n; i++) {
                ...
                for (j = 0, k = optgroups && optgroups.length; j < k; j++) {
                    ...
                    if (
                        ...
                        var regGroup;
                        if (
                            (regGroup = self.settings.optionGroupRegister.apply(
                                self,
                                [optgroup]
                            ))
                        ) {
        ...
        getFirstItemMatchedByTextContent: function (textContent, ignoreCase) {
            ignoreCase =
                ignoreCase !== null && ignoreCase === true ? true : false;
                ...
                typeof self.settings.create === "function"
                    ...
                    : function (input) {
                          ...
                          if (
                              ...
                              typeof self.settings.formatValueToKey ===
                                  "function"
                          ) {
            ...
            if (
                ...
                if (this.settings.dropdownSize.sizeType === "numberItems") {
                    ...
                    var paddingTop = this.$dropdown_content.css("padding-top")
                        ...
                        : 0;
                    var paddingBottom = this.$dropdown_content.css(
                        "padding-bottom"
                    )
                        ? Number(
                              this.$dropdown_content
                    ...
                    this.settings.dropdownSize.sizeType !== "fixedHeight"
                ) {
                    console.warn(
    ...
    $.fn.selectize = function (settings_user) {
        ...
        return this.each(function () {
            ...
            if (
                ...
                $input.html(
                    '<option value="">' + label + "</option>" + input_html
                );
            }
