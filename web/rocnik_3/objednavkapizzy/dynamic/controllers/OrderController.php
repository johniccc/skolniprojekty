...
class OrderController implements Controller
{
  ...
  public function initPage()
  {
    ...
    $ingredientsBase = $this->orderModel->getIngredientsByType('base');
    $ingredientsCheese = $this->orderModel->getIngredientsByType('cheese');
    $ingredientsMeat = $this->orderModel->getIngredientsByType('meat');
    $ingredientsVegetables = $this->orderModel->getIngredientsByType('vegetables');
    $ingredientsOther = $this->orderModel->getIngredientsByType('other');
    $ingredientsImg = $this->orderModel->getAllIngredients();
