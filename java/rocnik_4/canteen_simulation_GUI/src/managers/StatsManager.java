...
public class StatsManager {
  ...
  public synchronized void setFinalQueueSize(int queueSize) {
  ...
  public synchronized void printStats() {
    ...
    System.out.println("\nCurrently eating customers: " + (totalCustomersOverall - totalCustomersServed
        - totalQueueSize));
    System.out.println("Total customers in queues: " + totalQueueSize);

    System.out.println("\nTotal customers: " + totalCustomersOverall);
    ...
    // System.out
    // .println("The seat count IS" + ((totalUtilization > 80) ? " NOT" : "") + "
    // sufficient for the customers.");
    System.out.println("=".repeat(60));
  }
}